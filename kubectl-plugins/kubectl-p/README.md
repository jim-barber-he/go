...
```
  ...
  -n, --namespace string       If present, the namespace scope for this CLI request
      --node regex             Limit output to pods running on nodes matching this regex
      --not-name regex         Limit output to pods with names not matching this regex
      --not-status regex       Limit output to pods with a status not matching this regex
      --profile-cpu filename   Produce pprof cpu profiling output in supplied file
      --profile-mem filename   Produce pprof memory profiling output in supplied file
  -l, --selector string        Selector (label query) to filter on
      --status regex           Limit output to pods with a status matching this regex
